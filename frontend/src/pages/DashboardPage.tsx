...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-pink-100 flex flex-col items-center p-4">
      ...
      <Card className="max-w-4xl w-full relative p-8">
        ...
        <div className="mb-6 flex justify-center">
          <Button
            ...
            variant="primary"
            size="lg"
            className="px-8 py-4 text-lg font-bold transform hover:scale-105 transition-all duration-200 shadow-lg flex items-center gap-3"
          >
          ...
          <nav className="-mb-px flex space-x-8" aria-label="Tabs">
            <Button
              ...
              className={`${activeTab === 'messages'
                ...
                } whitespace-nowrap py-4 px-1 border-b-2 font-semibold text-sm transition duration-200 rounded-none`}
            >
              Messages
            </Button>
            <Button
